...
public class PlayerController {
    ...
    @PutMapping("/{playerId}/assign-to-equipe/{equipeId}")
    public PlayerDTO assignToEquipe(
            @PathVariable String playerId,
            @PathVariable Long equipeId) {
        return playerService.assignPlayerToEquipe(playerId, equipeId);
    }

    @GetMapping("/{playerId}/with-equipe")
    public PlayerWithEquipeDTO getPlayerWithEquipeDetails(
            @PathVariable String playerId) {
        return playerService.getPlayerWithEquipeDetails(playerId);
    }
